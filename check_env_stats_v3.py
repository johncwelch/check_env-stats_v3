...
# v1.3 addition of Juniper temp support and Juniper perfdata support
...
def main():
	...
	#this section is why crit/warning are passed as lists. Adds more flexibility.
	#i may change this at some point, but doubtful
	if warn:
